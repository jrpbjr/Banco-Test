...
import com.test.banco.dtos.EnderecoDto;
...
import com.test.banco.models.Endereco;
...
class ClienteServiceTest {
    ...
    public static final TipoOperacaoConta TIPO_OPERACAOPF = TipoOperacaoConta.CONTACORRENTEPF;
    ...
    public static final TipoOperacaoConta TIPO_OPERACAOPJ = TipoOperacaoConta.CONTACORRENTEPJ;
    ...
    private void startCliente() {
        ...
        Endereco endereco = new Endereco(IDENDERECO, CEP, RUA, NUMERO, COMPLEMENTO, BAIRRO, CIDADE, UF);
        EnderecoDto enderecoDto = new EnderecoDto(CEP, RUA, NUMERO, COMPLEMENTO, BAIRRO, CIDADE, UF);
        pessoaFisica = new PessoaFisica(IDPF, NOME, EMAIL, TELEFONE, CELULAR, endereco, contapf, CRIADO_EM, ALTERADO_EM, STATUS, CPF, RG, DT_NASCIMENTO, GENERO);

        optionalPessoaFisica = Optional.of(new PessoaFisica(IDPF, NOME, EMAIL, TELEFONE, CELULAR, endereco, contapf, CRIADO_EM, ALTERADO_EM, STATUS, CPF, RG, DT_NASCIMENTO, GENERO));

        pessoaFisicaUpdateDto = new PessoaFisicaUpdateDto(IDPF, DT_NASCIMENTO, NOME, EMAIL, TELEFONE, CELULAR, enderecoDto, "FEMININO");
        pessoaJuridica = new PessoaJuridica(IDPJ, NOMEPJ, EMAIL, TELEFONE, CELULAR, endereco, contapj, CRIADO_EM, ALTERADO_EM, STATUS, NOMEPJ, CNPJ, NOME);

        optionalPessoaJuridica = Optional.of(new PessoaJuridica(IDPJ, NOMEPJ, EMAIL, TELEFONE, CELULAR, endereco, contapj, CRIADO_EM, ALTERADO_EM, STATUS, NOMEPJ, CNPJ, NOME));
