...
public class Conta {
    ...
    private TipoOperacaoConta operacaoConta;
    ...
    public Conta(String id, int numero_conta, int agencia, TipoOperacaoConta operacaoConta, BigDecimal saldo, boolean status) {
        this.id = id;
